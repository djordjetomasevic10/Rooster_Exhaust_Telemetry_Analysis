...
wav_path = 'rooster_May12.wav'   # place the WAV in same folder or edit path
...
plt.ylim(10,5000)
plt.xlim(0.6, 15.0)     # <-- Add this line here to crop the time axis
...
ax1.set_xlim(0.6, 15.0)  # <-- Add this line here to crop the time axis
