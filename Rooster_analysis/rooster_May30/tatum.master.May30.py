...
wav_path = 'rooster_May30.wav'   # place the WAV in same folder or edit path
...
for i in range(len(t)):
    ...
    if np.max(col) < 1e-11: 
        ...
        search_mask = (f_sel >= 15) & (f_sel <= 150)
...
plt.ylim(10,5000)
plt.xlim(0.85, 35.0)     # <-- Add this line here to crop the time axis
...
ax1.set_xlim(0.85, 35.0)  # <-- Add this line here to crop the time axis
